# Outline: Word Formation: Prefixes, Suffixes, and How Words Are Built

- **Slug:** word-formation-prefixes-suffixes
- **Title:** Word Formation: Prefixes, Suffixes, and How Words Are Built
- **SEO description:** Learn Word Formation: Prefixes, Suffixes, and How Words Are Built with clear rules, exam-focused examples, common mistakes, and quick practice for error spotting, MCQs, and writing.
- **Categories:** English Grammar, Writing Skills
- **Tags:** word, formation, prefixes, suffixes, English grammar
- **Translation key:** word-formation-prefixes-suffixes
- **Status:** OUTLINED
...
- **Core concept:** Word formation changes meaning or word class through prefixes, suffixes, and roots.
- **Key rule:** Use suffixes to choose part of speech and prefixes to adjust meaning.
...
- **Common errors:** Success (noun), successful (adjective), succeed (verb).; Unpossible → impossible.; Careful vs careless have opposite meanings.; He is an honesty person. → honest person.
...
### 1. Introduction
Open with the everyday confusion behind Word Formation: Prefixes, Suffixes, and How Words Are Built. Use a wrong-versus-right pair from the mistakes list, then explain why this topic matters for school grammar, competitive exams, and clean writing.

### 2. Core Meaning and Rule
Explain the core concept in student-friendly language: Word formation changes meaning or word class through prefixes, suffixes, and roots. State the rule as a boxed takeaway: Use suffixes to choose part of speech and prefixes to adjust meaning.
...
Provide 8-10 graded examples: simple school-level sentences first, then exam-style sentences with distractors. Must include examples like: Success (noun), successful (adjective), succeed (verb).; impossible.; Careful vs careless have opposite meanings.; honest person.. Mark the target grammar in bold in the final post.
...
- Careful vs careless have opposite meanings.
- He is an honesty person. → honest person.
