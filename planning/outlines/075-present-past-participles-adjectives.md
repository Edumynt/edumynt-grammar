# Outline: Present and Past Participles as Adjectives: "Bored" vs "Boring"

- **Slug:** present-past-participles-adjectives
- **Title:** Present and Past Participles as Adjectives: "Bored" vs "Boring"
- **SEO description:** Learn Present and Past Participles as Adjectives: "Bored" vs "Boring" with clear rules, exam-focused examples, common mistakes, and quick practice for error spotting, MCQs, and writing.
- **Categories:** English Grammar, Writing Skills
- **Tags:** present, past, participles, adjectives, English grammar
- **Translation key:** present-past-participles-adjectives
- **Status:** OUTLINED
...
- **Core concept:** Present participles describe what causes a feeling; past participles describe who/what experiences it.
- **Key rule:** -ing = causing; -ed = affected/feeling.
...
- **Common errors:** I am boring. → I am bored.; The movie was bored. → boring.; She is interested in grammar. (correct); This lesson is confused. → confusing.
...
### 1. Introduction
Open with the everyday confusion behind Present and Past Participles as Adjectives: "Bored" vs "Boring". Use a wrong-versus-right pair from the mistakes list, then explain why this topic matters for school grammar, competitive exams, and clean writing.

### 2. Core Meaning and Rule
Explain the core concept in student-friendly language: Present participles describe what causes a feeling; past participles describe who/what experiences it. State the rule as a boxed takeaway: -ing = causing; -ed = affected/feeling.
...
Provide 8-10 graded examples: simple school-level sentences first, then exam-style sentences with distractors. Must include examples like: I am bored.; boring.; She is interested in grammar. (correct); confusing.. Mark the target grammar in bold in the final post.
...
- She is interested in grammar. (correct)
- This lesson is confused. → confusing.
