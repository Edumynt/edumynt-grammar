# Outline: Phrasal Verbs and Their Grammar: Separable, Inseparable, and Tricky

- **Slug:** phrasal-verbs-grammar-rules
- **Title:** Phrasal Verbs and Their Grammar: Separable, Inseparable, and Tricky
- **SEO description:** Learn Phrasal Verbs and Their Grammar: Separable, Inseparable, and Tricky with clear rules, exam-focused examples, common mistakes, and quick practice for error spotting, MCQs, and writing.
- **Categories:** English Grammar, Writing Skills
- **Tags:** phrasal, verbs, grammar, rules, English grammar
- **Translation key:** phrasal-verbs-grammar-rules
- **Status:** OUTLINED
...
- **Core concept:** Phrasal verbs combine a verb and particle; some are separable, inseparable, transitive, or intransitive.
- **Key rule:** Know whether the phrasal verb takes an object and whether pronoun objects must go between verb and particle.
...
- **Common errors:** Turn off it. → Turn it off.; Look after the child. (inseparable); Give up smoking. (transitive gerund object); The plane took off. (intransitive).
...
### 1. Introduction
Open with the everyday confusion behind Phrasal Verbs and Their Grammar: Separable, Inseparable, and Tricky. Use a wrong-versus-right pair from the mistakes list, then explain why this topic matters for school grammar, competitive exams, and clean writing.

### 2. Core Meaning and Rule
Explain the core concept in student-friendly language: Phrasal verbs combine a verb and particle; some are separable, inseparable, transitive, or intransitive. State the rule as a boxed takeaway: Know whether the phrasal verb takes an object and whether pronoun objects must go between verb and particle.
...
Provide 8-10 graded examples: simple school-level sentences first, then exam-style sentences with distractors. Must include examples like: Turn it off.; Look after the child. (inseparable); Give up smoking. (transitive gerund object); The plane took off. (intransitive).. Mark the target grammar in bold in the final post.
...
- Give up smoking. (transitive gerund object)
