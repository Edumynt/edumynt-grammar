...
export const SITE: SiteConfig = {
  ...
  title: 'Grammar By Edumynt',
  /** Site tagline / description. */
  description:
    'English grammar in clean, simple lessons for exams and real use.',
  /** Author/handle shown in footer + meta. */
  author: {
    name: 'Edumynt',
    url: GITHUB_HANDLE ? `https://github.com/${GITHUB_HANDLE}` : undefined,
    avatar: avatarImg,
    bio: 'English grammar in clean, simple lessons for exams and real use.',
  },
  /** Default OG image. */
